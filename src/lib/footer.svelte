...
<footer class="bg-primary-500">
	...
	<div class="img-container">
		...
		<div class="social-container">
			<a href="https://www.instagram.com/teamunwired_nitcalicut/"><img src="/img/instagram.webp"
																			 class="social-icon" alt="Instagram"></a>
			<a href="https://www.youtube.com/channel/UCZ-1FWuBQePQeAdoZx1S7Pw"><img src="/img/youtube.png"
																					class="social-icon"
																					alt="Youtube"></a>
			<a href="https://www.linkedin.com/company/team-unwired/"><img src="/img/linkedin.png" class="social-icon"
																		  alt="LinkedIn"></a>
		</div>
	</div>
</footer>
